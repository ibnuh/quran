...
<template>
  <div
    v-if="hasError"
    class="fixed top-0 right-0 bottom-0 left-0 flex flex-col items-center justify-center bg-surface text-center px-6"
  >
    ...
    <h1 class="text-lg font-semibold text-body mb-2">{{ $t('app.somethingWrong') }}</h1>
