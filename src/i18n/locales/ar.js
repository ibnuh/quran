export default {
  ...
  header: {
    ...
    listenModeShort: 'استماع',
    readModeShort: 'قراءة',
    layoutSingleShort: 'مفرد',
    layoutContinuousShort: 'تمرير',
    listenModeDesc: 'تشغيل الصوت مع المشغّل الكامل',
    readModeDesc: 'قراءة هادئة بشريط مضغوط',
    layoutSingleDesc: 'التركيز على آية واحدة',
    layoutContinuousDesc: 'تمرير السورة كاملة',
    activityMode: 'طريقة الاستخدام',
    layoutMode: 'عرض الآيات',
    modeMenuTitle: 'وضع القراءة',
  ...
  panels: {
    ...
    recent: 'الأخيرة',
    suggested: 'مقترحة',
    suggestedHint: 'سور شائعة للبدء',
    versesIn: 'آيات في {surah}',
    goToAyah: 'الانتقال إلى {surah} الآية {verse}',
    noMatchesTitle: 'لا توجد نتائج',
    noMatches: 'جرّب اسم سورة أو رقمها أو مرجعًا مثل 2:255. يشمل بحث الآيات السورة الحالية فقط.',
    tafsir: 'التفسير',
    ...
    footnoteOf: 'الحاشية {current} من {total}',
    prevFootnote: 'الحاشية السابقة',
    nextFootnote: 'الحاشية التالية',
    dismissHint: 'انقر خارج اللوحة، أو على نفس الحاشية، أو اضغط Esc للإغلاق',
  ...
  settings: {
    ...
    readModeHint:
      'التركيز على القراءة: مشغّل مضغوط وتحديد الآيات دون تشغيل تلقائي (يعمل مع أي تخطيط)',
    readingLayout: 'تخطيط القراءة',
    readingLayoutHint: 'كيف تُعرض الآيات في الصفحة',
    layoutSingle: 'آية واحدة',
    layoutContinuous: 'متواصل',
    ...
    downloading: 'جارٍ تنزيل {surah}...',
    downloadingProgress: 'جارٍ تنزيل {surah}: {current}/{total}',
  ...
  feature: {
    ...
    footnotesBody:
      'تعرض بعض الترجمات (مثل صحيح إنترناشونال) الآن ملاحظات مرقّمة. انقر على العلامة في الترجمة لقراءتها. يمكنك إيقافها من الإعدادات.',
    gotIt: 'حسنًا',
    dismiss: 'تجاهل'
  },
  errors: {
