...
<template>
  <Transition name="update-toast">
    <div
      v-if="show"
      class="fixed top-18 left-4 right-4 sm:left-auto sm:right-6 sm:w-80 z-30 bg-card border border-border rounded-xl shadow-2xl px-4 py-3 flex items-center gap-3"
    >
