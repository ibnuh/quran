        ...
        <div class="bg-card border-b border-border">
          <div class="flex items-center flex-wrap gap-3 px-4 py-2.5 max-w-7xl mx-auto">
            ...
            <button
              ...
              :aria-label="$t('header.toggleDisplay')"
            ...
            <button
              ...
              :aria-label="$t('header.collapseBar')"
              @click="emit('collapse')"
            >
          ...
          <div
            class="font-settings-shell"
            :class="showFontSettings ? 'font-settings-shell-open' : ''"
          >
...
.settings-bar-shell {
  ...
  pointer-events: none;
  transition:
    grid-template-rows 0.25s cubic-bezier(0.25, 1, 0.5, 1),
