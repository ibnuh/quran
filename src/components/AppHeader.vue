...
<template>
  <header class="flex items-center justify-between px-3 py-2 landscape-compact:py-1 bg-primary text-white pl-[max(0.75rem,env(safe-area-inset-left))] pr-[max(0.75rem,env(safe-area-inset-right))]" style="padding-top: max(0.5rem, env(safe-area-inset-top, 0px))">
