...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_aplayer__ = __webpack_require__(34);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_aplayer_dist_APlayer_min_css__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_aplayer_dist_APlayer_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_aplayer_dist_APlayer_min_css__);
...
window.vue = new Vue({
    ...
    mounted: function mounted() {
        ...
        axios.get('/sample/grab.json').then(function (res) {
            _this.verses = res.data;
        }).then(function (res) {
            _this.count();
        });
    },
    ...
    methods: {
        ...
        initPlayer: function initPlayer() {
            ...
            this.player = new __WEBPACK_IMPORTED_MODULE_0_aplayer___default.a({
            ...
            this.player.on('durationchange', function () {
                console.log(_this2.player.audio.duration);
                _this2.current++;
            });
        },
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../css-loader/index.js!./APlayer.min.css", function() {
			var newContent = require("!!../../css-loader/index.js!./APlayer.min.css");
